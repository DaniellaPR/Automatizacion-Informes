...
#Asignar productos por plazo
# o hacer lista y presentar en lista haciendo validación
#validación antiusuarios en menu
#vista cintrilador separa rne carpetas
...
if (seleccion_menu == "1"):
    ...
    if(int(usuario_seleccion) <= ultimo_valor):
        ...
        print(f"Lo sentimos, no existe el Producto {usuario_seleccion}.")
        print()

elif (seleccion_menu == "3"):
    print("se vienen cositaas")
#UwU
"""
"""
